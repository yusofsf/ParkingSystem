...
@section('title', 'All Your Cars')

@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="mb-8 text-center text-3xl font-bold">Your Cars</h1>
        <!-- Loading State -->
        ...
        <div id="addCar">
            <div class="rounded-lg border border-green-200 bg-green-50 p-4 text-center">
                <p class="mt-2 text-sm text-green-600">Add Your car</p>
                <a
                    href="/cars/create"
    ...
    <script>
        function showLoading() {
            ...
            document.getElementById('addCar').classList.add('hidden');
        }
        ...
        function showNoCars() {
            ...
            document.getElementById('errorMessage').classList.add('hidden');
            document.getElementById('addCar').classList.remove('hidden');
        }
        ...
        async function fetchCars() {
            ...
            try {
                const response = await fetch(`/api/users/${localStorage.getItem('user_id')}/cars`, {
                    headers: {
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="mt-4 flex justify-between">
                            <a href="/cars/${car.id}/update"
                               class="text-green-600 hover:text-green-800 text-sm font-medium">
                                update
                            </a>
                            <button id="select" onclick="bookCar(${car.id})"
        ...
        async function bookCar(carId) {
            ...
            if (sessionStorage.getItem('slot_id')) {
